...
MIDDLEWARE_CLASSES = (
    ...
    'rek.rekvizitka.middlewares.CompanyEmployeeMiddleware',
    'rek.rekvizitka.middlewares.DisableClientSideCachingMiddleware'
)

ROOT_URLCONF = 'rek.urls'
...
COMBO_SRV_CACHE_TIMEOUT = 24 * 3600
UNREAD_MESSAGE_EMAIL_NOTIFY_TIMEOUT = 5
